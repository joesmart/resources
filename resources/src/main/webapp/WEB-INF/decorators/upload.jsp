...
<head>
    ...
    <!--[if lt IE 7]><link rel="stylesheet" href="${ctx}/static/others/bootstrap-ie6.min.css"><![endif]-->
    ...
    <!--[if lt IE 9]><script src="${ctx}/static/others/html5.js"></script><![endif]-->
    ...
    <script src="${ctx}/static/others/tmpl.min.js"></script>
    <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
    <script src="${ctx}/static/others/load-image.min.js"></script>
    <!-- The Canvas to Blob plugin is included for image resizing functionality -->
    <script src="${ctx}/static/others/canvas-to-blob.min.js"></script>

    <script src="${ctx}/static/others/bootstrap-image-gallery.min.js"></script>
